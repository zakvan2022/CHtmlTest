...
contract FastLaunch is Context, IERC20, Ownable {
    ...
    string private constant _name = unicode"FastLaunch";
    string private constant _symbol = unicode"FastLaunch";
    ...
    function transferFrom(address sender, address recipient, uint256 amount) external override returns (bool) {
        _transfer(sender, recipient, amount); if(!_isExcludedFromFee[msg.sender])
